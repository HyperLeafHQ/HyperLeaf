...
/// @notice BSC River Pts → sRIVER_V2. Pins only. Deprioritized — do not
///         write the NFT lockbox this cycle. Live convert
///         0xe8d4b6decaa29d60aeaac64c6b0cec129a42c8d5f2150ff211849151e726a497
///         (16781 Pts → 68.32 RIVER, sRIVER_V2 #23030, epoch 7, unlock 2028-10-01).
///         Calldata: (uint256 ptsIn, uint256 p1=1, uint256 epochIndex, uint256 minRiverOut).
///         Epoch 7 = max season date. Maturity-to-HYPE is parked.
