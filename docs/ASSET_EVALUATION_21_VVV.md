...
Accounting: staking emissions are yield; buyback/burn is value capture, not direct claimable yield; DIEM is a separate compute asset and not hVVV backing. Maintain `totalLeafLiability <= verified economically realizable NAV`.
