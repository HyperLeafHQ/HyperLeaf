...
| hDAI | `docs/HDAI.md` · `feat/hdai` | later, capped. Wrap gtDAIcore only, never DAI / Blue |
| hRLUSD | `docs/HRLUSD.md` · `feat/hrlusd` | later. Wrap senRLUSDv2 only, never RLUSD / Blue |
