...
| skip | **PUMP** | — | Solana / HyperEVM | Official UPUMP on HyperCore. Buyback, no stake yield |
| skip | **DASH** | — | Dash | Masternode 1000 DASH. No LST. Not EVM |
| skip | **OKB** | — | X Layer | Gas token. No staked-OKB receipt. Do not wrap raw OKB |
| skip | **MNT** | — | Mantle | Official Hyperliquid spot. Lock = MP points. mETH is ETH LST last |
